...
{{--                            @enderror--}}
{{--                        </div>--}}
{{--                        --}}{{--                        <a class="btn btn-info mb-4" href="{{ route('admin.type.create') }}">Создать вид издания</a>--}}
...
{{--                            @enderror--}}
{{--                        </div>--}}
{{--                        <a class="btn btn-info mb-4" href="{{ route('admin.format.create') }}">Создать формат издания</a>--}}
